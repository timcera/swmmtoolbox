...
latex_documents = [
    ("index", "SWMMToolbox.tex", "SWMMToolbox Documentation", "Tim Cera", "manual")
]
...
man_pages = [("index", "swmmtoolbox", "SWMMToolbox Documentation", ["Tim Cera"], 1)]
...
texinfo_documents = [
    (
        ...
        "Tim Cera",
        "SWMMToolbox",
        "Dump data from SWMM5 binary output files.",
        "Miscellaneous",
    )
]
